"""prob2(trap) iter 예산 sweep: 180/780/2400 (1 iter=1분 → 3h/13h/40h)."""
...
ref = Problem(); _, J = ref.coordinate_ascent(np.random.default_rng(0), restarts=60)
...
print(f"prob2 J*={J:.2f}")
sweep(lambda s: Problem(seed=s), ALGOS, nmse, list(range(3)), [180,780,2400],
      "prob2 block — iter budget", "prob2/itersweep.png", "normalized MSE")
